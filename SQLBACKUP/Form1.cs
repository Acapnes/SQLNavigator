...
namespace SQLBACKUP
{
    public partial class Form1 : Form
    {
        ...
        //      "Data Source=" + "."/*conString.Text*/ + ";" +
        //      "Initial Catalog= master ;" +
        //      "User id=" + "sa"/*conUsername.Text*/ + ";" +
        //      "Password=" + "guncel@123"/*conPassword.Text*/ + ";";
        //    conn.Open();
        //    return conn;
        //}
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (checkAuth.Checked == true)
                {
                    ...
                    //command.CommandText = "USE Example SELECT * FROM sys.Tables";
                ...
                {
                    SqlCommand command = new SqlCommand("SELECT NAME FROM master.sys.databases", SqlFuncs.SqlConnection());
        ...
        {
            if (!String.IsNullOrEmpty(conString.Text) && !String.IsNullOrEmpty(conPassword.Text) && !String.IsNullOrEmpty(conUsername.Text))
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Server srv = new Server(new Microsoft.SqlServer.Management.Common.ServerConnection("GNC-NB122", "sa", "guncel@123"));
        ...
        {
            //SqlDataAdapter Adapter = new SqlDataAdapter("SELECT * FROM " + comboTables.SelectedItem.ToString() + " ", "server = " + conString.Text + "; database = " + listdb.SelectedItem.ToString() + " ; UID = " + conUsername.Text + "; password = " + conPassword.Text + "");
            SqlDataAdapter Adapter = new SqlDataAdapter("SELECT * FROM " + comboTables.SelectedItem.ToString() + " ", "server = " + conString.Text + "; database = " + listdb.SelectedItem.ToString() + " ; UID = sa; password = guncel@123");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("BACKUP DATABASE " + listdb.SelectedItem.ToString() + "  TO DISK = '" + folderPath + "' ", conn);
            command.ExecuteNonQuery();
        }
        ...
        private void listdb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                command.CommandText = "USE " + listdb.SelectedItem.ToString() + " SELECT * FROM sys.Tables";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < dataGridView1.CurrentRow.Cells.Count; i++)
                {
                    ...
                    {
                        if (dataGridView1.CurrentRow.Cells[i].ValueType == typeof(int))
                            updateQuery += dataGridView1.CurrentRow.Cells[i].OwningColumn.HeaderText.ToString() + " = " + dataGridView1.CurrentRow.Cells[i].Value.ToString();
                ...
                updateQuery += " WHERE " + dataGridView1.CurrentRow.Cells[0].OwningColumn.HeaderText.ToString() + " = " + dataGridView1.CurrentRow.Cells[0].Value.ToString() + "";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                string deleteQuery = "DELETE FROM " + comboTables.SelectedItem.ToString() + " WHERE ";

                deleteQuery += dataGridView1.CurrentRow.Cells[0].OwningColumn.HeaderText.ToString() + " = " + dataGridView1.CurrentRow.Cells[0].Value.ToString();
        ...
        private void btnCmdInsert_Click(object sender, EventArgs e)
        {
            ...
            {
                txtCommand.Text = $"INSERT INTO {comboTables.SelectedItem.ToString()} VALUES (<Value 1>, <Value 2>)";
            }
            else
            {
        ...
        private void btnCmdUpdate_Click(object sender, EventArgs e)
        {
            if (comboTables.SelectedItem != null)
            {
                txtCommand.Text = $"UPDATE {comboTables.SelectedItem.ToString()} SET <Column 1 = Value 1>, <Column 2 = Value 2> WHERE ExampleId = ExampleId";
            }
            else
            {
                txtCommand.Text = "UPDATE <Table Name> SET <Column 1 = Value 1>, <Column 2 = Value 2> WHERE ExampleId = ExampleId";
            }
        }
        ...
        private void btnCmdDelete_Click(object sender, EventArgs e)
        {
            if (comboTables.SelectedItem != null)
            {
                txtCommand.Text = $"DELETE FROM {comboTables.SelectedItem.ToString()} WHERE ExampleId = ExampleId";
            }
            else
            {
